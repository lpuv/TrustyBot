...
class Leveler:
    ...
    @checks.mod_or_permissions(manage_roles=True)
    @levelrole.command(name = 'link', no_pm=True, pass_context=True)
    ...
    @checks.mod_or_permissions(manage_roles=True)
    @levelrole.command(name = 'unlink', no_pm=True, pass_context=True)
    ...
    @checks.mod_or_permissions(manage_roles=True)
    @levelrole.command(name = 'listlinks', no_pm=True, pass_context=True)
