                ...
                async for message in self.bot.logs_from(chn, limit=10000000):
                    if message.attachments != []:
                        for file in message.attachments:
                            ...
                            file_loc = "data/backup/{}/files/{}".format(server.name, "{}-{}".format(message.id, file["filename"][:-6]))
                ...
                async for message in self.bot.logs_from(chn, limit=10000000):
                    ...
                    if message.attachments != []:
                        for file in message.attachments:
                            ...
                            file_loc = "data/backup/{}/files/{}".format(server.name, "{}-{}".format(message.id, file["filename"][5:]))
                            with open(file_loc, "wb") as file:
                                file.write(img_data)
                            files_saved += 1
